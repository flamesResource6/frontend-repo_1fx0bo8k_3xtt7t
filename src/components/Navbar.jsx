  ...
  return (
    <header className="sticky top-0 z-20 backdrop-blur supports-[backdrop-filter]:bg-slate-900/60 bg-slate-900/40 border-b border-white/10" dir={dir}>
      <div className="max-w-6xl mx-auto px-4 md:px-6 h-16 flex items-center justify-between">
        ...
        <div className="flex items-center gap-3">
          <button className="px-3 py-1.5 text-sm rounded-lg bg-white/10 text-white hover:bg-white/20">{t.nav.bookNow}</button>
          <button className="p-2 rounded-lg hover:bg-white/5" title={t.nav.appointments}><Calendar className="w-5 h-5 text-white" /></button>
          <button className="p-2 rounded-lg hover:bg-white/5" title={t.nav.payments}><CreditCard className="w-5 h-5 text-white" /></button>
          <button className="p-2 rounded-lg hover:bg-white/5" title={t.nav.account}><User className="w-5 h-5 text-white" /></button>
